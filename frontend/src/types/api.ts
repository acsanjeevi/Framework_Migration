...
// ──────────────────────────────────────────────────────────────────────────────
// Workspace folder tree (mirrored from backend WorkspaceManager.ts)
// ──────────────────────────────────────────────────────────────────────────────
...
export interface UploadResponse {
  ...
  websocket: string
  message: string
  /** Folder tree of workspace/INPUT/<jobId> after extraction */
  inputFolder?: FolderNode[]
  /** Files inside the ZIP that were skipped (unsupported types) */
  skippedFiles?: string[]
...
export interface BatchResult {
  ...
  /** Folder tree of workspace/OUTPUT/<jobId> after migration completes */
